...
// Options contains all options which will be applied when instantiating algorithm ants pool.
type Options struct {
	// ExpiryDuration is algorithm period for the scavenger goroutine to clean up those expired workers,
...
// WithLogger sets up algorithm customized logger.
...
请在提 PR 之前仔细阅读 [Contributing Guidelines](../../../../../../Downloads/ants-master/CONTRIBUTING.md)，感谢那些为 `ants` 贡献过代码的开发者！
