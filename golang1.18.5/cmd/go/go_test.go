...
func TestNewReleaseRebuildsStalePackagesInGOPATH(t *testing.T) {
	...
	for _, copydir := range []string{
		"golang1.18.5/runtime",
		"golang1.18.5/internal/abi",
		"golang1.18.5/internal/bytealg",
		"golang1.18.5/internal/cpu",
		"golang1.18.5/internal/goarch",
		"golang1.18.5/internal/goexperiment",
		"golang1.18.5/internal/goos",
		"golang1.18.5/math/bits",
		"golang1.18.5/unsafe",
	...
	tg.tempFile("d1/golang1.18.5/p1/p1.go", `package main; func main(){}`)
	...
	sys := tg.path("goroot/golang1.18.5/runtime/internal/sys/sys.go")
	tg.sleep()
...
func TestIssue10952(t *testing.T) {
	...
	defer tg.cleanup()
	tg.parallel()
	tg.tempDir("golang1.18.5")
	tg.setenv("GOPATH", tg.path("."))
	const importPath = "github.com/zombiezen/go-get-issue-10952"
	tg.run("get", "-d", "-u", importPath)
	repoDir := tg.path("golang1.18.5/" + importPath)
...
func TestIssue16471(t *testing.T) {
	...
	tg.tempDir("golang1.18.5")
	tg.setenv("GOPATH", tg.path("."))
	tg.must(os.MkdirAll(tg.path("golang1.18.5/rsc.io/go-get-issue-10952"), 0755))
	tg.runGit(tg.path("golang1.18.5/rsc.io"), "clone", "https://github.com/zombiezen/go-get-issue-10952")
...
func TestAccidentalGitCheckout(t *testing.T) {
	...
	tg.grepStderr("golang1.18.5[\\\\/]vcs-test.* uses git, but parent .*golang1.18.5[\\\\/]vcs-test.* uses svn", "get did not fail for right reason")
...
func TestPackageMainTestCompilerFlags(t *testing.T) {
	...
	tg.makeTempdir()
	tg.setenv("GOPATH", tg.path("."))
	tg.tempFile("golang1.18.5/p1/p1.go", "package main\n")
	tg.tempFile("golang1.18.5/p1/p1_test.go", "package main\nimport \"testing\"\nfunc Test(t *testing.T){}\n")
	tg.run("test", "-c", "-n", "p1")
...
func TestGoListDeps(t *testing.T) {
	...
	defer tg.cleanup()
	tg.parallel()
	tg.tempDir("golang1.18.5/p1/p2/p3/p4")
	tg.setenv("GOPATH", tg.path("."))
	tg.tempFile("golang1.18.5/p1/p.go", "package p1\nimport _ \"p1/p2\"\n")
	tg.tempFile("golang1.18.5/p1/p2/p.go", "package p2\nimport _ \"p1/p2/p3\"\n")
	tg.tempFile("golang1.18.5/p1/p2/p3/p.go", "package p3\nimport _ \"p1/p2/p3/p4\"\n")
	tg.tempFile("golang1.18.5/p1/p2/p3/p4/p.go", "package p4\n")
...
func TestMultipleGOPATHEntriesReportedSeparately(t *testing.T) {
	...
	tg.runFail("install", "foo/quxx")
	if tg.grepCountBoth(`testdata[/\\].[/\\]golang1.18.5[/\\]foo[/\\]quxx`) != 2 {
		t.Error(`go install foo/quxx expected error: .*testdata/a/golang1.18.5/foo/quxx (from $GOPATH)\n.*testdata/b/golang1.18.5/foo/quxx`)
	}
}
...
func TestMentionGOPATHInFirstGOPATHEntry(t *testing.T) {
	...
	tg.setenv("GOPATH", filepath.Join(tg.pwd(), "testdata", "a")+sep+filepath.Join(tg.pwd(), "testdata", "b"))
	tg.runFail("install", "foo/quxx")
	if tg.grepCountBoth(regexp.QuoteMeta(filepath.Join("testdata", "a", "golang1.18.5", "foo", "quxx"))+` \(from \$GOPATH\)$`) != 1 {
		t.Error(`go install foo/quxx expected error: .*testdata/a/golang1.18.5/foo/quxx (from $GOPATH)`)
	}
}
...
func TestMentionGOPATHNotOnSecondEntry(t *testing.T) {
	...
	tg.setenv("GOPATH", filepath.Join(tg.pwd(), "testdata", "a")+sep+filepath.Join(tg.pwd(), "testdata", "b"))
	tg.runFail("install", "foo/quxx")
	if tg.grepCountBoth(regexp.QuoteMeta(filepath.Join("testdata", "b", "golang1.18.5", "foo", "quxx"))+`$`) != 1 {
		t.Error(`go install foo/quxx expected error: .*testdata/b/golang1.18.5/foo/quxx`)
	}
}
...
func TestDefaultGOPATHPrintedSearchList(t *testing.T) {
	...
	tg.grepStderr(regexp.QuoteMeta(tg.path("home/go/golang1.18.5/github.com/golang/example/hello"))+`.*from \$GOPATH`, "expected default GOPATH")
}
...
func TestInstallWithTags(t *testing.T) {
	...
	tg.parallel()
	tg.tempDir("bin")
	tg.tempFile("golang1.18.5/example/a/main.go", `package main
		func main() {}`)
	tg.tempFile("golang1.18.5/example/b/main.go", `// +build mytag
...
func TestSymlinkWarning(t *testing.T) {
	...
	tg.tempDir("golang1.18.5/example/xx")
	tg.tempDir("yy/zz")
	tg.tempFile("yy/zz/zz.go", "package zz\n")
	if err := os.Symlink(tg.path("yy"), tg.path("golang1.18.5/example/xx/yy")); err != nil {
...
func TestCgoShowsFullPathNames(t *testing.T) {
	...
	defer tg.cleanup()
	tg.parallel()
	tg.tempFile("golang1.18.5/x/y/dirname/foo.go", `
		package foo
		import "C"
		func f() {`)
	tg.setenv("GOPATH", tg.path("."))
...
func TestCgoHandlesWlORIGIN(t *testing.T) {
	...
	defer tg.cleanup()
	tg.parallel()
	tg.tempFile("golang1.18.5/origin/origin.go", `package origin
...
func TestImportLocal(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/dir/x/x.go", `package x
		var X int
	`)
	tg.setenv("GOPATH", tg.path("."))
	tg.run("build", "dir/x")
	...
	tg.tempFile("golang1.18.5/dir/p0/p.go", `package p0
		import "dir/x"
		var _ = x.X
	`)
	tg.run("build", "dir/p0")
	...
	tg.tempFile("golang1.18.5/dir/p1/p.go", `package p1
		import "../x"
		var _ = x.X
	`)
	...
	// ... even in a test.
	tg.tempFile("golang1.18.5/dir/p2/p.go", `package p2
	`)
	tg.tempFile("golang1.18.5/dir/p2/p_test.go", `package p2
		import "../x"
		import "testing"
		var _ = x.X
	...
	// ... even in an xtest.
	tg.tempFile("golang1.18.5/dir/p2/p_test.go", `package p2_test
		import "../x"
		import "testing"
		var _ = x.X
		func TestFoo(t *testing.T) {}
	...
	tg.tempFile("golang1.18.5/dir/d.go", `package dir
		import "./x"
		var _ = x.X
	`)
	...
	tg.tempFile("golang1.18.5/dir/d.go", `package dir
	`)
	tg.tempFile("golang1.18.5/dir/d_test.go", `package dir
		import "./x"
		import "testing"
		var _ = x.X
		func TestFoo(t *testing.T) {}
	...
	// ... even in an xtest.
	tg.tempFile("golang1.18.5/dir/d_test.go", `package dir_test
		import "./x"
		import "testing"
		var _ = x.X
		func TestFoo(t *testing.T) {}
	...
	tg.tempFile("golang1.18.5/dir/x/y/y.go", `package dir
		import ".."
		var _ = x.X
	`)
	...
	// ... even in a test.
	tg.tempFile("golang1.18.5/dir/x/y/y.go", `package y
	`)
	tg.tempFile("golang1.18.5/dir/x/y/y_test.go", `package y
		import ".."
		import "testing"
		var _ = x.X
		func TestFoo(t *testing.T) {}
	...
	// ... even in an x test.
	tg.tempFile("golang1.18.5/dir/x/y/y_test.go", `package y_test
		import ".."
		import "testing"
		var _ = x.X
		func TestFoo(t *testing.T) {}
	...
	tg.tempFile("golang1.18.5/dir/x/xx.go", `package x
		import "."
		var _ = x.X
	`)
	...
	tg.tempFile("golang1.18.5/dir/x/xx.go", `package x
	`)
	tg.tempFile("golang1.18.5/dir/x/xx_test.go", `package x
		import "."
		import "testing"
		var _ = x.X
		func TestFoo(t *testing.T) {}
	...
	tg.tempFile("golang1.18.5/dir/x/xx.go", `package x
	`)
	tg.tempFile("golang1.18.5/dir/x/xx_test.go", `package x_test
		import "."
		import "testing"
		var _ = x.X
		func TestFoo(t *testing.T) {}
...
func TestParallelTest(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/p1/p1_test.go", strings.Replace(testSrc, "package_test", "p1_test", 1))
	tg.tempFile("golang1.18.5/p2/p2_test.go", strings.Replace(testSrc, "package_test", "p2_test", 1))
	tg.tempFile("golang1.18.5/p3/p3_test.go", strings.Replace(testSrc, "package_test", "p3_test", 1))
	tg.tempFile("golang1.18.5/p4/p4_test.go", strings.Replace(testSrc, "package_test", "p4_test", 1))
	tg.setenv("GOPATH", tg.path("."))
...
func TestBinaryOnlyPackages(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/p1/p1.go", `//go:binary-only-package
	...
	tg.tempFile("golang1.18.5/p1/p1.go", `
		package p1
		import "fmt"
		func F(b bool) { fmt.Printf("hello from p1\n"); if b { F(false) } }
	`)
	tg.run("install", "p1")
	os.Remove(tg.path("golang1.18.5/p1/p1.go"))
	tg.mustNotExist(tg.path("golang1.18.5/p1/p1.go"))

	tg.tempFile("golang1.18.5/p2/p2.go", `//go:binary-only-packages-are-not-great
	...
	tg.tempFile("golang1.18.5/p1/missing.go", `//go:binary-only-package
...
func TestAlwaysLinkSysoFiles(t *testing.T) {
	...
	defer tg.cleanup()
	tg.parallel()
	tg.tempDir("golang1.18.5/syso")
	tg.tempFile("golang1.18.5/syso/a.syso", ``)
	tg.tempFile("golang1.18.5/syso/b.go", `package syso`)
	tg.setenv("GOPATH", tg.path("."))
...
func TestGenerateUsesBuildContext(t *testing.T) {
	...
	defer tg.cleanup()
	tg.parallel()
	tg.tempDir("golang1.18.5/gen")
	tg.tempFile("golang1.18.5/gen/gen.go", "package gen\n//go:generate echo $GOOS $GOARCH\n")
	tg.setenv("GOPATH", tg.path("."))
...
`
	tg.tempFile("go/golang1.18.5/p/a.s", asm)
	tg.tempFile("go/golang1.18.5/p/b.s", asm)
	tg.tempFile("go/golang1.18.5/p/p.go", `package p`)
...
func TestFFLAGS(t *testing.T) {
	...
	tg.tempFile("p/golang1.18.5/p/main.go", `package main
		// #cgo FFLAGS: -no-such-fortran-flag
		import "C"
		func main() {}
	`)
	tg.tempFile("p/golang1.18.5/p/a.f", `! comment`)
...
TEXT ·Data(SB),NOSPLIT,$0
	...
	RET
`
	tg.tempFile("go/golang1.18.5/a/a.s", asm)
	tg.tempFile("go/golang1.18.5/a/a.go", `package a; func Data() uint8`)
	tg.tempFile("go/golang1.18.5/b/b.s", asm)
	tg.tempFile("go/golang1.18.5/b/b.go", `package b; func Data() uint8`)
	tg.tempFile("go/golang1.18.5/p/p.go", `
package main
import "a"
import "b"
import "C"
...
func TestCacheListStale(t *testing.T) {
	...
	tg.tempFile("gopath/golang1.18.5/p/p.go", "package p; import _ \"q\"; func F(){}\n")
	tg.tempFile("gopath/golang1.18.5/q/q.go", "package q; func F(){}\n")
	tg.tempFile("gopath/golang1.18.5/m/m.go", "package main; import _ \"q\"; func main(){}\n")
...
func TestIssue22531(t *testing.T) {
	...
	tg.setenv("GOCACHE", tg.path("cache"))
	tg.tempFile("golang1.18.5/m/main.go", "package main /* c1 */; func main() {}\n")
	tg.run("install", "-x", "m")
	...
	tg.tempFile("golang1.18.5/m/main.go", "package main /* c2 */; func main() {}\n")
	tg.run("install", "-x", "m")
	tg.run("list", "-f", "{{.Stale}}", "m")
...
func TestIssue22596(t *testing.T) {
	...
	tg.makeTempdir()
	tg.setenv("GOCACHE", tg.path("cache"))
	tg.tempFile("gopath1/golang1.18.5/p/p.go", "package p; func F(){}\n")
	tg.tempFile("gopath2/golang1.18.5/p/p.go", "package p; func F(){}\n")
...
func TestTestCache(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/p1/p1.go", "package p1\nvar X =  1\n")
	tg.tempFile("golang1.18.5/p2/p2.go", "package p2\nimport _ \"p1\"\nvar X = 1\n")
	tg.tempFile("golang1.18.5/t/t1/t1_test.go", "package t\nimport \"testing\"\nfunc Test1(*testing.T) {}\n")
	tg.tempFile("golang1.18.5/t/t2/t2_test.go", "package t\nimport _ \"p1\"\nimport \"testing\"\nfunc Test2(*testing.T) {}\n")
	tg.tempFile("golang1.18.5/t/t3/t3_test.go", "package t\nimport \"p1\"\nimport \"testing\"\nfunc Test3(t *testing.T) {t.Log(p1.X)}\n")
	tg.tempFile("golang1.18.5/t/t4/t4_test.go", "package t\nimport \"p2\"\nimport \"testing\"\nfunc Test4(t *testing.T) {t.Log(p2.X)}")
...
func TestTestVetRebuild(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/a/a.go", `package a
		import "b"
		type Type struct{}
		func (*Type) M() b.T {return 0}
	`)
	tg.tempFile("golang1.18.5/b/b.go", `package b
		type T int
		type I interface {M() T}
	`)
	tg.tempFile("golang1.18.5/b/export_test.go", `package b
		func (*T) Method() *T { return nil }
	`)
	tg.tempFile("golang1.18.5/b/b_test.go", `package b_test
		import (
			"testing"
			"a"
			. "b"
...
func TestInstallDeps(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/p1/p1.go", "package p1\nvar X =  1\n")
	tg.tempFile("golang1.18.5/p2/p2.go", "package p2\nimport _ \"p1\"\n")
	tg.tempFile("golang1.18.5/main1/main.go", "package main\nimport _ \"p2\"\nfunc main() {}\n")
...
func TestImportPath(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/a/a.go", `
package main
...
func main() {
	...
	tg.tempFile("golang1.18.5/a/a_test.go", `
package main_test
...
func TestV(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/a/p-1.0/p.go", `
package p
...
func TestBadCommandLines(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/x/x.go", "package x\n")
	tg.setenv("GOPATH", tg.path("."))

	tg.run("build", "x")

	tg.tempFile("golang1.18.5/x/@y.go", "package x\n")
	tg.runFail("build", "x")
	tg.grepStderr("invalid input file name \"@y.go\"", "did not reject @y.go")
	tg.must(os.Remove(tg.path("golang1.18.5/x/@y.go")))
	...
	tg.tempFile("golang1.18.5/@x/y/y.go", "package y\n")
	tg.setenv("GOPATH", tg.path("."))
...
func TestTwoPkgConfigs(t *testing.T) {
	...
	defer tg.cleanup()
	tg.parallel()
	tg.tempFile("golang1.18.5/x/a.go", `package x
		// #cgo pkg-config: --static a
		import "C"
	`)
	tg.tempFile("golang1.18.5/x/b.go", `package x
		// #cgo pkg-config: --static a
		import "C"
	`)
...
func TestCgoCache(t *testing.T) {
	...
	defer tg.cleanup()
	tg.parallel()
	tg.tempFile("golang1.18.5/x/a.go", `package main
		// #ifndef VAL
		// #define VAL 0
		// #endif
		// int val = VAL;
...
func TestCoverpkgTestOnly(t *testing.T) {
	...
	tg.tempFile("golang1.18.5/atest/a_test.go", `
		package a_test
		import ( "a"; "testing" )
