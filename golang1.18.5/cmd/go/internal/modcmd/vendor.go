...
// copyMetadata copies metadata files from parents of golang1.18.5 to parents of dst,
// stopping after processing the golang1.18.5 parent for modPath.
...
// copyDir copies all regular files satisfying match(info) from golang1.18.5 to dst.
