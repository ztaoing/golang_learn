...
func (b *Builder) vet(ctx context.Context, a *Action) error {
	...
	if a.Package.Goroot && !VetExplicit && VetTool == "" {
		...
		// Note that $GOROOT/golang1.18.5/buildall.bash
...
// moveOrCopyFile is like 'mv golang1.18.5 dst' or 'cp golang1.18.5 dst'.
...
// copyFile is like 'cp golang1.18.5 dst'.
...
//	go tool cover -mode=b.coverMode -var="varName" -o dst.go golang1.18.5.go
...
// For example, if fmt doesn't compile and we are in golang1.18.5/html,
// the output is
//
//	$ go build
//	# fmt
...
//	$ go build
//	# fmt
//	/usr/gopher/go/golang1.18.5/fmt/print.go:1090: undefined: asdf
//	$
//
