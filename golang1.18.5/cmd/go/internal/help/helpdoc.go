...
the directory DIR/golang1.18.5/P for some DIR listed in the GOPATH
...
GOPATH/golang1.18.5/example.org.
...
The golang1.18.5 directory holds source code. The path below golang1.18.5
...
source in DIR/golang1.18.5/foo/bar can be imported as "foo/bar" and
has its compiled form installed to "DIR/pkg/GOOS_GOARCH/foo/bar.a".

The bin directory holds compiled commands.
Each command is named for its source directory, but only
the final element, not the entire path. That is, the
command with source in DIR/golang1.18.5/foo/quux is installed into
...
Special-purpose environment variables:
	...
	GOEXPERIMENT
		...
		See golang1.18.5/internal/goexperiment/flags.go for currently valid values.
