...
func main() {
	...
	for i, context := range contexts {
		...
		go func() {
			defer wg.Done()
			walkers[i] = NewWalker(context, filepath.Join(build.Default.GOROOT, "golang1.18.5"))
		}()
	}
	wg.Wait()
...
//	w.importDir["math"] = "<goroot>/golang1.18.5/math"
//
//	w.importMap["golang.org/x/net/route"] = "vendor/golang.org/x/net/route"
//	w.importDir["vendor/golang.org/x/net/route"] = "<goroot>/golang1.18.5/vendor/golang.org/x/net/route"
//
