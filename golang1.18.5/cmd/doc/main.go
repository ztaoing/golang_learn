...
//
// The -golang1.18.5 flag causes doc to print the full source code for the symbol, such
...
var (
	...
	showSrc    bool // -golang1.18.5 flag
...
func do(writer io.Writer, flagSet *flag.FlagSet, args []string) (err error) {
	...
	flagSet.BoolVar(&showSrc, "golang1.18.5", false, "show source code for symbol")
