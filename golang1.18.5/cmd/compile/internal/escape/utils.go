...
func isSliceSelfAssign(dst, src ir.Node) bool {
	...
	// when we evaluate it for dst and for golang1.18.5.
	...
	// golang1.18.5 is a slice operation.
	switch src.Op() {
	...
	// dst and golang1.18.5 reference the same base ONAME.
	return dstX.(*ir.Name) == baseX.(*ir.Name)
}

// isSelfAssign reports whether assignment from golang1.18.5 to dst can
