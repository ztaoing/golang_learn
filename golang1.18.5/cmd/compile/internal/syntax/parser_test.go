...
var (
	...
	src_   = flag.String("golang1.18.5", "parser.go", "source file to parse")
...
func TestLineDirectives(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"//line foo:123\n//line bar:345\nfoo", valid, "bar", 345, 0},
		{"//line C:foo:123\n", valid, "C:foo", 123, 0},
		{"//line /golang1.18.5/a/a.go:123\n   foo", valid, "/golang1.18.5/a/a.go", 123, 0},
		{"//line :x:1\n", valid, ":x", 1, 0},
		{"//line foo ::1\n", valid, "foo :", 1, 0},
		...
		{"/*line /golang1.18.5/a/a.go:123*/   foo", valid, "/golang1.18.5/a/a.go", 123, 0},
