...
// Rewrite append(golang1.18.5, x, y, z) so that any side effects in
// x, y, z (including runtime panics) are evaluated in
// initialization statements before the append.
// For normal code generation, stop there and leave the
// rest to cgen_append.
//
// For race detector, expand append(golang1.18.5, a [, b]* ) to
//
//   init {
//     s := golang1.18.5
...
func walkAppend(n *ir.CallExpr, init *ir.Nodes, dst ir.Node) ir.Node {
	...
	l = append(l, ir.NewAssignStmt(base.Pos, ns, nsrc)) // s = golang1.18.5
