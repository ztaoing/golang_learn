...
func init() {
	...
	ops := []opData{
		...
		// arg1 = address of golang1.18.5 memory (in R20, changed as side effect)
		// arg2 = mem
		...
		// arg1 = address of golang1.18.5 memory (in R16 aka arm64.REGRT1, changed as side effect)
		// arg2 = address of the last element of golang1.18.5
		// arg3 = mem
		// returns mem
		//	MOVD.P	8(R16), Rtmp
		//	MOVD.P	Rtmp, 8(R17)
		//	CMP	Rarg2, R16
		//	BLE	-3(PC)
		// Note: the-end-of-golang1.18.5 may be not a valid pointer. it's a problem if it is spilled.
		// the-end-of-golang1.18.5 - 8 is within the area to copy, ok to spill.
		{
			name:      "LoweredMove",
			argLength: 4,
			reg: regInfo{
