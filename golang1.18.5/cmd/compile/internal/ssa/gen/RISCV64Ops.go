...
func init() {
	...
	RISCV64ops := []opData{
		...
		// arg1 = address of golang1.18.5 memory (in X10, changed as side effect)
		// arg2 = mem
		...
		// arg1 = address of golang1.18.5 memory (in X6, changed as side effect)
		// arg2 = address of the last element of golang1.18.5 (can't be X7 as we clobber it before using arg2)
		// arg3 = mem
		// auxint = alignment
