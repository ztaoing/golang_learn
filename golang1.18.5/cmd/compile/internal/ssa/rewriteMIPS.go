...
func rewriteValueMIPS_OpMove(v *Value) bool {
	...
	// result: (MOVBstore [1] dst (MOVBUload [1] golang1.18.5 mem) (MOVBstore dst (MOVBUload golang1.18.5 mem) mem))
	for {
		if auxIntToInt64(v.AuxInt) != 2 {
			break
		}
	...
	// match: (Move [4] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%2 == 0
	// result: (MOVHstore [2] dst (MOVHUload [2] golang1.18.5 mem) (MOVHstore dst (MOVHUload golang1.18.5 mem) mem))
	for {
		if auxIntToInt64(v.AuxInt) != 4 {
			break
		}
	...
	// result: (MOVBstore [3] dst (MOVBUload [3] golang1.18.5 mem) (MOVBstore [2] dst (MOVBUload [2] golang1.18.5 mem) (MOVBstore [1] dst (MOVBUload [1] golang1.18.5 mem) (MOVBstore dst (MOVBUload golang1.18.5 mem) mem))))
	for {
		if auxIntToInt64(v.AuxInt) != 4 {
			break
		}
	...
	// result: (MOVBstore [2] dst (MOVBUload [2] golang1.18.5 mem) (MOVBstore [1] dst (MOVBUload [1] golang1.18.5 mem) (MOVBstore dst (MOVBUload golang1.18.5 mem) mem)))
	for {
	...
	// cond: t.Alignment()%4 == 0
	// result: (MOVWstore [12] dst (MOVWload [12] golang1.18.5 mem) (MOVWstore [8] dst (MOVWload [8] golang1.18.5 mem) (MOVWstore [4] dst (MOVWload [4] golang1.18.5 mem) (MOVWstore dst (MOVWload golang1.18.5 mem) mem))))
	for {
	...
	// result: (LoweredMove [int32(t.Alignment())] dst golang1.18.5 (ADDconst <golang1.18.5.Type> golang1.18.5 [int32(s-moveSize(t.Alignment(), config))]) mem)
	for {
