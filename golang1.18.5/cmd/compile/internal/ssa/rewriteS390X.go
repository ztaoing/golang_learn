...
func rewriteValueS390X_OpMove(v *Value) bool {
	...
	// result: (MOVBstore dst (MOVBZload golang1.18.5 mem) mem)
	for {
	...
	// result: (MOVHstore dst (MOVHZload golang1.18.5 mem) mem)
	for {
	...
	// result: (MOVWstore dst (MOVWZload golang1.18.5 mem) mem)
	for {
	...
	// result: (MOVBstore [2] dst (MOVBZload [2] golang1.18.5 mem) (MOVHstore dst (MOVHZload golang1.18.5 mem) mem))
	for {
	...
	// result: (MOVBstore [4] dst (MOVBZload [4] golang1.18.5 mem) (MOVWstore dst (MOVWZload golang1.18.5 mem) mem))
	for {
	...
	// result: (MOVHstore [4] dst (MOVHZload [4] golang1.18.5 mem) (MOVWstore dst (MOVWZload golang1.18.5 mem) mem))
	for {
	...
	// result: (MOVBstore [6] dst (MOVBZload [6] golang1.18.5 mem) (MOVHstore [4] dst (MOVHZload [4] golang1.18.5 mem) (MOVWstore dst (MOVWZload golang1.18.5 mem) mem)))
	for {
	...
	// result: (MVC [makeValAndOff(int32(s), 0)] dst golang1.18.5 mem)
	for {
	...
	// result: (MVC [makeValAndOff(int32(s)-256, 256)] dst golang1.18.5 (MVC [makeValAndOff(256, 0)] dst golang1.18.5 mem))
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// result: (MVC [makeValAndOff(int32(s)-512, 512)] dst golang1.18.5 (MVC [makeValAndOff(256, 256)] dst golang1.18.5 (MVC [makeValAndOff(256, 0)] dst golang1.18.5 mem)))
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// result: (MVC [makeValAndOff(int32(s)-768, 768)] dst golang1.18.5 (MVC [makeValAndOff(256, 512)] dst golang1.18.5 (MVC [makeValAndOff(256, 256)] dst golang1.18.5 (MVC [makeValAndOff(256, 0)] dst golang1.18.5 mem))))
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// result: (LoweredMove [s%256] dst golang1.18.5 (ADD <golang1.18.5.Type> golang1.18.5 (MOVDconst [(s/256)*256])) mem)
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
