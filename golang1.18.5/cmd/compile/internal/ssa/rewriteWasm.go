...
func rewriteValueWasm_OpMove(v *Value) bool {
	...
	// result: (I64Store8 dst (I64Load8U golang1.18.5 mem) mem)
	for {
	...
	// result: (I64Store16 dst (I64Load16U golang1.18.5 mem) mem)
	for {
	...
	// result: (I64Store32 dst (I64Load32U golang1.18.5 mem) mem)
	for {
	...
	// result: (I64Store dst (I64Load golang1.18.5 mem) mem)
	for {
	...
	// result: (I64Store [8] dst (I64Load [8] golang1.18.5 mem) (I64Store dst (I64Load golang1.18.5 mem) mem))
	for {
	...
	// result: (I64Store8 [2] dst (I64Load8U [2] golang1.18.5 mem) (I64Store16 dst (I64Load16U golang1.18.5 mem) mem))
	for {
	...
	// result: (I64Store8 [4] dst (I64Load8U [4] golang1.18.5 mem) (I64Store32 dst (I64Load32U golang1.18.5 mem) mem))
	for {
	...
	// result: (I64Store16 [4] dst (I64Load16U [4] golang1.18.5 mem) (I64Store32 dst (I64Load32U golang1.18.5 mem) mem))
	for {
	...
	// result: (I64Store32 [3] dst (I64Load32U [3] golang1.18.5 mem) (I64Store32 dst (I64Load32U golang1.18.5 mem) mem))
	for {
	...
	// cond: s > 8 && s < 16
	// result: (I64Store [s-8] dst (I64Load [s-8] golang1.18.5 mem) (I64Store dst (I64Load golang1.18.5 mem) mem))
	for {
	...
	// result: (Move [s-s%16] (OffPtr <dst.Type> dst [s%16]) (OffPtr <golang1.18.5.Type> golang1.18.5 [s%16]) (I64Store dst (I64Load golang1.18.5 mem) mem))
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// match: (Move [s] dst golang1.18.5 mem)
	// cond: s > 16 && s%16 != 0 && s%16 > 8
	// result: (Move [s-s%16] (OffPtr <dst.Type> dst [s%16]) (OffPtr <golang1.18.5.Type> golang1.18.5 [s%16]) (I64Store [8] dst (I64Load [8] golang1.18.5 mem) (I64Store dst (I64Load golang1.18.5 mem) mem)))
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// result: (LoweredMove [s/8] dst golang1.18.5 mem)
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
