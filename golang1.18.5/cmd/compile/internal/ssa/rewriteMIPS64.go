...
func rewriteValueMIPS64_OpMove(v *Value) bool {
	...
	// result: (MOVVstore dst (MOVVload golang1.18.5 mem) mem)
	for {
	...
	// cond: t.Alignment()%8 == 0
	// result: (MOVVstore [8] dst (MOVVload [8] golang1.18.5 mem) (MOVVstore dst (MOVVload golang1.18.5 mem) mem))
	for {
	...
	// cond: t.Alignment()%8 == 0
	// result: (MOVVstore [16] dst (MOVVload [16] golang1.18.5 mem) (MOVVstore [8] dst (MOVVload [8] golang1.18.5 mem) (MOVVstore dst (MOVVload golang1.18.5 mem) mem)))
	for {
	...
	// result: (LoweredMove [t.Alignment()] dst golang1.18.5 (ADDVconst <golang1.18.5.Type> golang1.18.5 [s-moveSize(t.Alignment(), config)]) mem)
	for {
		s := auxIntToInt64(v.AuxInt)
		t := auxToType(v.Aux)
		dst := v_0
