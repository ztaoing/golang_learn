...
func rewriteValueRISCV64_OpMove(v *Value) bool {
	...
	// match: (Move [2] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%2 == 0
	// result: (MOVHstore dst (MOVHload golang1.18.5 mem) mem)
	for {
	...
	// result: (MOVBstore [1] dst (MOVBload [1] golang1.18.5 mem) (MOVBstore dst (MOVBload golang1.18.5 mem) mem))
	for {
		if auxIntToInt64(v.AuxInt) != 2 {
			break
		}
	...
	// match: (Move [4] {t} dst golang1.18.5 mem)
	...
	// match: (Move [4] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%2 == 0
	// result: (MOVHstore [2] dst (MOVHload [2] golang1.18.5 mem) (MOVHstore dst (MOVHload golang1.18.5 mem) mem))
	for {
		if auxIntToInt64(v.AuxInt) != 4 {
			break
		}
	...
	// result: (MOVBstore [3] dst (MOVBload [3] golang1.18.5 mem) (MOVBstore [2] dst (MOVBload [2] golang1.18.5 mem) (MOVBstore [1] dst (MOVBload [1] golang1.18.5 mem) (MOVBstore dst (MOVBload golang1.18.5 mem) mem))))
	for {
		if auxIntToInt64(v.AuxInt) != 4 {
			break
		}
	...
	// match: (Move [8] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%8 == 0
	// result: (MOVDstore dst (MOVDload golang1.18.5 mem) mem)
	for {
	...
	// match: (Move [8] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%4 == 0
	// result: (MOVWstore [4] dst (MOVWload [4] golang1.18.5 mem) (MOVWstore dst (MOVWload golang1.18.5 mem) mem))
	for {
		if auxIntToInt64(v.AuxInt) != 8 {
			break
		}
	...
	// match: (Move [8] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%2 == 0
	// result: (MOVHstore [6] dst (MOVHload [6] golang1.18.5 mem) (MOVHstore [4] dst (MOVHload [4] golang1.18.5 mem) (MOVHstore [2] dst (MOVHload [2] golang1.18.5 mem) (MOVHstore dst (MOVHload golang1.18.5 mem) mem))))
	for {
		if auxIntToInt64(v.AuxInt) != 8 {
			break
		}
	...
	// result: (MOVBstore [2] dst (MOVBload [2] golang1.18.5 mem) (MOVBstore [1] dst (MOVBload [1] golang1.18.5 mem) (MOVBstore dst (MOVBload golang1.18.5 mem) mem)))
	for {
	...
	// match: (Move [6] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%2 == 0
	// result: (MOVHstore [4] dst (MOVHload [4] golang1.18.5 mem) (MOVHstore [2] dst (MOVHload [2] golang1.18.5 mem) (MOVHstore dst (MOVHload golang1.18.5 mem) mem)))
	for {
	...
	// match: (Move [12] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%4 == 0
	// result: (MOVWstore [8] dst (MOVWload [8] golang1.18.5 mem) (MOVWstore [4] dst (MOVWload [4] golang1.18.5 mem) (MOVWstore dst (MOVWload golang1.18.5 mem) mem)))
	for {
	...
	// match: (Move [16] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%8 == 0
	// result: (MOVDstore [8] dst (MOVDload [8] golang1.18.5 mem) (MOVDstore dst (MOVDload golang1.18.5 mem) mem))
	for {
	...
	// match: (Move [24] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%8 == 0
	// result: (MOVDstore [16] dst (MOVDload [16] golang1.18.5 mem) (MOVDstore [8] dst (MOVDload [8] golang1.18.5 mem) (MOVDstore dst (MOVDload golang1.18.5 mem) mem)))
	for {
	...
	// match: (Move [32] {t} dst golang1.18.5 mem)
	// cond: t.Alignment()%8 == 0
	// result: (MOVDstore [24] dst (MOVDload [24] golang1.18.5 mem) (MOVDstore [16] dst (MOVDload [16] golang1.18.5 mem) (MOVDstore [8] dst (MOVDload [8] golang1.18.5 mem) (MOVDstore dst (MOVDload golang1.18.5 mem) mem))))
	for {
	...
	// match: (Move [s] {t} dst golang1.18.5 mem)
	// cond: s%8 == 0 && s <= 8*128 && t.Alignment()%8 == 0 && !config.noDuffDevice && logLargeCopy(v, s)
	// result: (DUFFCOPY [16 * (128 - s/8)] dst golang1.18.5 mem)
	for {
	...
	// result: (LoweredMove [t.Alignment()] dst golang1.18.5 (ADDI <golang1.18.5.Type> [s-moveSize(t.Alignment(), config)] golang1.18.5) mem)
	for {
		s := auxIntToInt64(v.AuxInt)
		t := auxToType(v.Aux)
		dst := v_0
