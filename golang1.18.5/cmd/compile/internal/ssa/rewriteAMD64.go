...
func rewriteValueAMD64_OpMove(v *Value) bool {
	...
	// match: (Move [1] dst golang1.18.5 mem)
	// result: (MOVBstore dst (MOVBload golang1.18.5 mem) mem)
	for {
	...
	// match: (Move [2] dst golang1.18.5 mem)
	// result: (MOVWstore dst (MOVWload golang1.18.5 mem) mem)
	for {
	...
	// match: (Move [4] dst golang1.18.5 mem)
	// result: (MOVLstore dst (MOVLload golang1.18.5 mem) mem)
	for {
	...
	// match: (Move [8] dst golang1.18.5 mem)
	// result: (MOVQstore dst (MOVQload golang1.18.5 mem) mem)
	for {
	...
	// match: (Move [16] dst golang1.18.5 mem)
	// cond: config.useSSE
	// result: (MOVOstore dst (MOVOload golang1.18.5 mem) mem)
	for {
	...
	// match: (Move [16] dst golang1.18.5 mem)
	// cond: !config.useSSE
	// result: (MOVQstore [8] dst (MOVQload [8] golang1.18.5 mem) (MOVQstore dst (MOVQload golang1.18.5 mem) mem))
	for {
		if auxIntToInt64(v.AuxInt) != 16 {
			break
		}
	...
	// match: (Move [32] dst golang1.18.5 mem)
	// result: (Move [16] (OffPtr <dst.Type> dst [16]) (OffPtr <golang1.18.5.Type> golang1.18.5 [16]) (Move [16] dst golang1.18.5 mem))
	for {
	...
	// match: (Move [48] dst golang1.18.5 mem)
	// cond: config.useSSE
	// result: (Move [32] (OffPtr <dst.Type> dst [16]) (OffPtr <golang1.18.5.Type> golang1.18.5 [16]) (Move [16] dst golang1.18.5 mem))
	for {
	...
	// match: (Move [64] dst golang1.18.5 mem)
	// cond: config.useSSE
	// result: (Move [32] (OffPtr <dst.Type> dst [32]) (OffPtr <golang1.18.5.Type> golang1.18.5 [32]) (Move [32] dst golang1.18.5 mem))
	for {
	...
	// match: (Move [3] dst golang1.18.5 mem)
	// result: (MOVBstore [2] dst (MOVBload [2] golang1.18.5 mem) (MOVWstore dst (MOVWload golang1.18.5 mem) mem))
	for {
	...
	// match: (Move [5] dst golang1.18.5 mem)
	// result: (MOVBstore [4] dst (MOVBload [4] golang1.18.5 mem) (MOVLstore dst (MOVLload golang1.18.5 mem) mem))
	for {
	...
	// match: (Move [6] dst golang1.18.5 mem)
	// result: (MOVWstore [4] dst (MOVWload [4] golang1.18.5 mem) (MOVLstore dst (MOVLload golang1.18.5 mem) mem))
	for {
	...
	// match: (Move [7] dst golang1.18.5 mem)
	// result: (MOVLstore [3] dst (MOVLload [3] golang1.18.5 mem) (MOVLstore dst (MOVLload golang1.18.5 mem) mem))
	for {
	...
	// match: (Move [9] dst golang1.18.5 mem)
	// result: (MOVBstore [8] dst (MOVBload [8] golang1.18.5 mem) (MOVQstore dst (MOVQload golang1.18.5 mem) mem))
	for {
	...
	// match: (Move [10] dst golang1.18.5 mem)
	// result: (MOVWstore [8] dst (MOVWload [8] golang1.18.5 mem) (MOVQstore dst (MOVQload golang1.18.5 mem) mem))
	for {
	...
	// match: (Move [12] dst golang1.18.5 mem)
	// result: (MOVLstore [8] dst (MOVLload [8] golang1.18.5 mem) (MOVQstore dst (MOVQload golang1.18.5 mem) mem))
	for {
	...
	// match: (Move [s] dst golang1.18.5 mem)
	// cond: s == 11 || s >= 13 && s <= 15
	// result: (MOVQstore [int32(s-8)] dst (MOVQload [int32(s-8)] golang1.18.5 mem) (MOVQstore dst (MOVQload golang1.18.5 mem) mem))
	for {
	...
	// result: (Move [s-s%16] (OffPtr <dst.Type> dst [s%16]) (OffPtr <golang1.18.5.Type> golang1.18.5 [s%16]) (MOVQstore dst (MOVQload golang1.18.5 mem) mem))
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// result: (Move [s-s%16] (OffPtr <dst.Type> dst [s%16]) (OffPtr <golang1.18.5.Type> golang1.18.5 [s%16]) (MOVOstore dst (MOVOload golang1.18.5 mem) mem))
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// match: (Move [s] dst golang1.18.5 mem)
	// cond: s > 16 && s%16 != 0 && s%16 > 8 && !config.useSSE
	// result: (Move [s-s%16] (OffPtr <dst.Type> dst [s%16]) (OffPtr <golang1.18.5.Type> golang1.18.5 [s%16]) (MOVQstore [8] dst (MOVQload [8] golang1.18.5 mem) (MOVQstore dst (MOVQload golang1.18.5 mem) mem)))
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// result: (DUFFCOPY [s] dst golang1.18.5 mem)
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// result: (REPMOVSQ dst golang1.18.5 (MOVQconst [s/8]) mem)
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
...
func rewriteValueAMD64_OpSelectN(v *Value) bool {
	...
	b := v.Block
	config := b.Func.Config
	// match: (SelectN [0] call:(CALLstatic {sym} s1:(MOVQstoreconst _ [sc] s2:(MOVQstore _ golang1.18.5 s3:(MOVQstore _ dst mem)))))
	// cond: sc.Val64() >= 0 && isSameCall(sym, "runtime.memmove") && s1.Uses == 1 && s2.Uses == 1 && s3.Uses == 1 && isInlinableMemmove(dst, golang1.18.5, sc.Val64(), config) && clobber(s1, s2, s3, call)
	// result: (Move [sc.Val64()] dst golang1.18.5 mem)
	for {
		if auxIntToInt64(v.AuxInt) != 0 {
			break
		}
	...
	// match: (SelectN [0] call:(CALLstatic {sym} dst golang1.18.5 (MOVQconst [sz]) mem))
	// cond: sz >= 0 && isSameCall(sym, "runtime.memmove") && call.Uses == 1 && isInlinableMemmove(dst, golang1.18.5, sz, config) && clobber(call)
	// result: (Move [sz] dst golang1.18.5 mem)
	for {
		if auxIntToInt64(v.AuxInt) != 0 {
			break
		}
