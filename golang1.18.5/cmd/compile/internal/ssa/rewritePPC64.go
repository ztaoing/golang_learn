...
func rewriteValuePPC64_OpMove(v *Value) bool {
	...
	// result: (MOVBstore [2] dst (MOVBZload [2] golang1.18.5 mem) (MOVHstore dst (MOVHload golang1.18.5 mem) mem))
	for {
	...
	// result: (LoweredMove [s] dst golang1.18.5 mem)
	for {
	...
	// result: (LoweredQuadMoveShort [s] dst golang1.18.5 mem)
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
	...
	// result: (LoweredQuadMove [s] dst golang1.18.5 mem)
	for {
		s := auxIntToInt64(v.AuxInt)
		dst := v_0
		src := v_1
