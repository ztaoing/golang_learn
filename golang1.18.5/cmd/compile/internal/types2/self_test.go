...
func BenchmarkCheck(b *testing.B) {
	for _, p := range []string{
		filepath.Join("golang1.18.5", "net", "http"),
		filepath.Join("golang1.18.5", "go", "parser"),
		filepath.Join("golang1.18.5", "go", "constant"),
		filepath.Join("golang1.18.5", "runtime"),
		filepath.Join("golang1.18.5", "go", "internal", "gcimporter"),
	} {
