...
// Copies golang1.18.5's children into dst. Copies attributes by value.
...
// appendSyms appends the syms from 'golang1.18.5' into 'syms' and returns the
...
func dwarfGenerateDebugInfo(ctxt *Link) {
	...
	for idx := loader.Sym(1); idx < loader.Sym(d.ldr.NDef()); idx++ {
		...
		// object symbols, and local symbols in assembler golang1.18.5 files).
