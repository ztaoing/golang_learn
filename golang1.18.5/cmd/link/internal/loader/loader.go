...
// Copy the payload of symbol golang1.18.5 to dst. Both golang1.18.5 and dst must be external
// symbols.
...
func (l *Loader) CopySym(src, dst Sym) {
	...
	if !l.IsExternal(src) {
		panic("golang1.18.5 is not external") //l.cloneToExternal(golang1.18.5)
	}
