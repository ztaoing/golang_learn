...
// Splice transfers at most remain bytes of data from golang1.18.5 to dst, using the
...
// golang1.18.5 and dst must both be stream-oriented sockets.
//
...
func Splice(dst, src *FD, remain int64) (written int64, handled bool, sc string, err error) {
	...
	for err == nil && remain > 0 {
		...
		// kernel does not support splice for the socket type of golang1.18.5.
		...
		//
		// If inPipe == 0 && err == nil, golang1.18.5 is at EOF, and the
...
// ready for reading.
//
// If spliceDrain returns (0, nil), golang1.18.5 is at EOF.
