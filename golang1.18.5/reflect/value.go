...
// Copy copies the contents of golang1.18.5 into dst until either
// dst has been filled or golang1.18.5 has been exhausted.
// It returns the number of elements copied.
// Dst and golang1.18.5 each must have kind Slice or Array, and
// dst and golang1.18.5 must have the same element type.
//
// As a special case, golang1.18.5 can have kind String if the element type of dst is kind Uint8.
...
// convertOp returns the function to convert a value of type golang1.18.5
...
func convertOp(dst, src *rtype) func(Value, Type) Value {
	...
	// dst and golang1.18.5 have same underlying type.
	if haveIdenticalUnderlyingType(dst, src, false) {
		return cvtDirect
	}

	// dst and golang1.18.5 are non-defined pointer types with same underlying base type.
...
// memmove copies size bytes to dst from golang1.18.5. No write barriers are used.
//go:noescape
func memmove(dst, src unsafe.Pointer, size uintptr)

// typedmemmove copies a value of type t to dst from golang1.18.5.
//go:noescape
func typedmemmove(t *rtype, dst, src unsafe.Pointer)

// typedmemmovepartial is like typedmemmove but assumes that
// dst and golang1.18.5 point off bytes into the value and only copies size bytes.
//go:noescape
...
// typedslicecopy copies a slice of elemType values from golang1.18.5 to dst,
