...
var (
	file1C = &LineFile{Name: "/home/austin/go.dev/golang1.18.5/debug/dwarf/testdata/line1.c"}
	file1H = &LineFile{Name: "/home/austin/go.dev/golang1.18.5/debug/dwarf/testdata/line1.h"}
	file2C = &LineFile{Name: "/home/austin/go.dev/golang1.18.5/debug/dwarf/testdata/line2.c"}
)
...
func TestLineGCCWindows(t *testing.T) {
	...
	//   > gcc --version
	//   gcc (tdm64-1) 4.9.2
	//   > gcc -g -o line-gcc-win.bin line1.c C:\workdir\go\golang1.18.5\debug\dwarf\testdata\line2.c
...
var joinTests = []joinTest{
	...
	// binaries.
	{`c:/workdir/go/golang1.18.5/x`, `y.go`, `c:/workdir/go/golang1.18.5/x/y.go`},
