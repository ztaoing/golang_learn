...
// Encode encodes golang1.18.5 into EncodedLen(len(golang1.18.5))
// bytes of dst. As a convenience, it returns the number
// of bytes written to dst, but this value is always EncodedLen(len(golang1.18.5)).
...
// Decode decodes golang1.18.5 into DecodedLen(len(golang1.18.5)) bytes,
// returning the actual number of bytes written to dst.
//
// Decode expects that golang1.18.5 contains only hexadecimal
// characters and that golang1.18.5 has even length.
...
// EncodeToString returns the hexadecimal encoding of golang1.18.5.
...
//
// DecodeString expects that golang1.18.5 contains only hexadecimal
// characters and that golang1.18.5 has even length.
