...
// Encode encodes golang1.18.5 using the encoding enc, writing
// EncodedLen(len(golang1.18.5)) bytes to dst.
//
...
// EncodeToString returns the base64 encoding of golang1.18.5.
...
// the destination buffer dst, the source buffer golang1.18.5 and an index in the
// source buffer si.
// It returns the number of bytes read from golang1.18.5, the number of bytes written
...
// Decode decodes golang1.18.5 using the encoding enc. It writes at most
// DecodedLen(len(golang1.18.5)) bytes to dst and returns the number of bytes
// written. If golang1.18.5 contains invalid base64 data, it will return the
