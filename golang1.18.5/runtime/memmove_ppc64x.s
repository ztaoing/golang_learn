...
check:
	...
	// Determine overlap by subtracting dest - golang1.18.5 and comparing against the
	// length.  This catches the cases where golang1.18.5 and dest are in different types
	// of storage such as stack and static to avoid doing backward move when not
	// necessary.

	SUB	SRC, TGT, TMP	// dest - golang1.18.5
