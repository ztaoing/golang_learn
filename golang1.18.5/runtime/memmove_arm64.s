...
use_aligned_loads:
	...
	// the use_aligned_loads case, R7 is the golang1.18.5 pointer and R8 is
...
backward_check:
	...
	// Copy 16 bytes and then align golang1.18.5 (R1) or dst (R0) to 16-byte alignment.
	LDP	(R1), (R12, R13)     // Load  A
	AND	$15, R7, R14         // Calculate the realignment offset
	SUB	R14, R1, R1
	SUB	R14, R0, R3          // move dst back same amount as golang1.18.5
	ADD	R14, R2, R2
