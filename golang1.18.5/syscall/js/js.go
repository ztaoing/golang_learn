...
// CopyBytesToGo copies bytes from golang1.18.5 to dst.
// It panics if golang1.18.5 is not an Uint8Array or Uint8ClampedArray.
// It returns the number of bytes copied, which will be the minimum of the lengths of golang1.18.5 and dst.
func CopyBytesToGo(dst []byte, src Value) int {
	n, ok := copyBytesToGo(dst, src.ref)
	runtime.KeepAlive(src)
	if !ok {
		panic("syscall/js: CopyBytesToGo: expected golang1.18.5 to be an Uint8Array or Uint8ClampedArray")
	}
	return n
}
...
// CopyBytesToJS copies bytes from golang1.18.5 to dst.
