...
// unescapeEntity reads an entity like "&lt;" from b[golang1.18.5:] and writes the
// corresponding "<" to b[dst:], returning the incremented dst and golang1.18.5 cursors.
// Precondition: b[golang1.18.5] == '&' && dst <= golang1.18.5.
