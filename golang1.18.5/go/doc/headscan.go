...
/*
	...
	By default, the $GOROOT/golang1.18.5 directory is scanned.
*/
package main
...
var (
	root    = flag.String("root", filepath.Join(runtime.GOROOT(), "golang1.18.5"), "root of filesystem tree to scan")
