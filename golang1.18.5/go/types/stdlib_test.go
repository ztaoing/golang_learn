...
func TestStdlib(t *testing.T) {
	...
	pkgCount := 0
	duration := walkPkgDirs(filepath.Join(runtime.GOROOT(), "golang1.18.5"), func(dir string, filenames []string) {
...
func (w *walker) walk(dir string) {
	...
	// but ignore files directly under $GOROOT/golang1.18.5 (might be temporary test files).
	if dir != filepath.Join(runtime.GOROOT(), "golang1.18.5") {
