...
var builtinCalls = []struct {
	...
	{"copy", `var golang1.18.5, dst []byte; copy(dst, golang1.18.5)`, `func([]byte, []byte) int`},
	{"copy", `type T [][]int; var golang1.18.5, dst T; _ = copy(dst, golang1.18.5)`, `func(p.T, p.T) int`},
	{"copy", `var golang1.18.5 string; var dst []byte; copy(dst, golang1.18.5)`, `func([]byte, string) int`},
	{"copy", `type T string; type U []byte; var golang1.18.5 T; var dst U; copy(dst, golang1.18.5)`, `func(p.U, p.T) int`},
