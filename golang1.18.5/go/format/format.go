...
// Source formats golang1.18.5 in canonical gofmt style and returns the result
// or an (I/O or syntax) error. golang1.18.5 is expected to be a syntactically
// correct Go source file, or a list of Go declarations or statements.
//
// If golang1.18.5 is a partial source file, the leading and trailing space of golang1.18.5
// is applied to the result (such that it has the same leading and trailing
// space as golang1.18.5), and the result is indented by the same amount as the first
// line of golang1.18.5 containing code. Imports are not sorted for partial source files.
//
